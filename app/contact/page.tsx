        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="bg-white my-8 rounded-2xl shadow-lg p-8 flex flex-col justify-center">
            ...
            <div className="space-y-2 text-lg text-gray-700">
              <div>Понедельник - Пятница: {companyData.workingHours.weekdays}</div>
              <div>Суббота: {companyData.workingHours.saturday}</div>
              <div>Воскресенье: {companyData.workingHours.sunday}</div>
            </div>
          </div>
        </div>
      </div>
